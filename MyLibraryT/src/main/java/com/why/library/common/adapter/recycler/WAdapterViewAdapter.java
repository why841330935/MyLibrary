...
/**
 * @ClassName WAdapterViewAdapter
 * @author  WangHuanyu
 * @todo AdapterView适配器
 * @date 2016/9/13 16:16
 */
public abstract class WAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public WAdapterViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final WAdapterViewHolder viewHolder = WAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
