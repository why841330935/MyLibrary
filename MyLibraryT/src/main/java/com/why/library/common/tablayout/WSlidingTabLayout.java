 ...
 * @author  WangHuanyu
 * @todo 滑动TabLayout,对于ViewPager的依赖性强
 * @date 2016/9/19 13:21
 */
public class WSlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public WSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.f_layout_tab, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.f_layout_tab, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
