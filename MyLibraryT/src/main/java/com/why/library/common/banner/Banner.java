package com.why.library.common.banner;
...
import com.why.library.common.banner.listener.OnBannerClickListener;
import com.why.library.common.banner.view.BannerViewPager;
import com.why.library.imageload.WImageLoader;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            WImageLoader.getInstance().loadImage(context, url.toString(), imageView);
        }
        setData();
    }
