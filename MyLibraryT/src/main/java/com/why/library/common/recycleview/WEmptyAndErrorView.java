...
/**
 * @ClassName WEmptyAndErrorView
 * @author  WangHuanyu
 * @todo
 * @date 2016/11/15 10:19
 */
public class WEmptyAndErrorView extends AutoFrameLayout implements NestedScrollingChild {
    NestedScrollingChildHelper helper;

    public WEmptyAndErrorView(Context context) {
        super(context);
        init();
    }

    public WEmptyAndErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WEmptyAndErrorView(Context context, AttributeSet attrs, int defStyleAttr) {
