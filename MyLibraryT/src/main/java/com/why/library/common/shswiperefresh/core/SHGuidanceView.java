...
import com.why.library.common.shswiperefresh.drawable.SHCircleProgressBar;
import com.why.library.common.shswiperefresh.util.DipUtils;


/**
 * @ClassName SHGuidanceView
 * @author  WangHuanyu
 * @todo
