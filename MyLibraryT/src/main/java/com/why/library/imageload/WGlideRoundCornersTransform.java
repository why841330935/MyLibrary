...
public class WGlideRoundCornersTransform implements Transformation<Bitmap>
{
  ...
  public WGlideRoundCornersTransform(Context context, int radius, int margin) {
    this(context, radius, margin, CornerType.ALL);
  }

  public WGlideRoundCornersTransform(BitmapPool pool, int radius, int margin) {
